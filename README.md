...
- **arXiv:** [Search on arXiv](https://arxiv.org/search/?query=Video-OPD+Temporal+Video+Grounding+Jiaze+Li)
- **Abstract:** Reinforcement learning has emerged as a principled post-training paradigm for Temporal Video Grounding (TVG) due to its on-policy optimization, yet existing GRPO-based methods remain fundamentally constrained by sparse reward signals and substantial computational overhead.
...
- **arXiv:** [Search on arXiv](https://arxiv.org/search/?query=On-policy+Verbal+Distillation+Jing+Xiong)
...
- **arXiv:** [Search on arXiv](https://arxiv.org/search/?query=Self-Distilled+Reasoner+Siyan+Zhao)
...
- **arXiv:** [Search on arXiv](https://arxiv.org/search/?query=Positive-Unlabeled+Reinforcement+Learning+Distillation+Zhiqiang+Kou)
...
- **Date:** January 29, 2026
- **arXiv:** [Search on arXiv](https://arxiv.org/search/?query=Continual+Policy+Distillation+Distributed+Yuxuan+Li)
...
- **Date:** January 28, 2026
- **arXiv:** [Search on arXiv](https://arxiv.org/search/?query=Reinforcement+Learning+via+Self-Distillation+Jonas+Hübotter)
...
- **arXiv:** [Search on arXiv](https://arxiv.org/search/?query=KEPO+Knowledge-Enhanced+Preference+Optimization+Fan+Yang)
...
- **arXiv:** [Search on arXiv](https://arxiv.org/search/?query=DISPO+Batuhan+Karaman+Mathematical+Reasoning)
...
- **arXiv:** [Search on arXiv](https://arxiv.org/search/?query=Typhoon-S+Minimal+Open+Post-Training+Kunat+Pipatanakul)
...
- **arXiv:** [Search on arXiv](https://arxiv.org/search/?query=Self-Distillation+Enables+Continual+Learning+Idan+Shenfeld)
- **Abstract:** Continual learning, enabling models to acquire new skills and knowledge without degrading existing capabilities, remains a fundamental challenge for foundation models. Learning from expert demonstrations is complemented by on-policy self-distillation methods.
...
1. Search arXiv for the paper title + first author to find the correct arXiv ID
2. Use format: `https://arxiv.org/abs/YYMM.NNNNN`
...
**Note:** Some papers may not yet have stable arXiv IDs. The search links provided will help locate the most recent versions. Please submit a PR if you find the actual arXiv IDs!
